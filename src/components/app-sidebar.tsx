...
import { Cpu, Plus, LogOut, Activity, User } from "lucide-react";
...
import type { ConnectionStatus, PlcProtocol } from "@/types/plc";
      ...
      <DialogContent>
        ...
        <div className="grid gap-3">
          ...
          <div className="grid gap-1.5">
            ...
            <Select value={form.protocol} onValueChange={(v) => setForm({ ...form, protocol: v as PlcProtocol })}>
